import pyspark
import sys, itertools, collections, math, operator, time


'''
    @para all_baskets is a list of sets
    @return a dictionary where key is the size of frequent itemsets,
            value is frequent itemsets
'''
...
def write_itemsets(file, itemsets):
...
if __name__ == "__main__":
    ...
    if case :
        rawRDD = rawRDD.map(lambda x: [x[1], x[0]])
